...
// Milestones a caller sends in an update may include ones just added in the same edit, which don't have a real id yet, the backend assigns one
type GoalUpdateBody = Partial<Omit<Goal, "milestones">> & {
...
export const goalService = {
  ...
  remove: (id: string) =>
    authedRequest<void>(`/goals/${id}`, { method: "DELETE" }),
};
